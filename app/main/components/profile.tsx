...
const ProfileTopSection = () => {
  const name = "John Doe";
  const username = "@recoveringJohn";
  const joinedAt = "March 2023";
  const daysSober = 250;
    ...
    <section className="flex flex-row-reverse border-b-2 border-gray-200 pb-8 md:flex-row md:gap-8">
      ...
      <div className="flex grow flex-col justify-between gap-3">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3">
            <span className="text-gray-500">{`${followingCount} Following / ${followersCount} Supporters`}</span>
          </div>
        </div>
      </div>
      <Link
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex items-center gap-3 rounded-2xl border-2 border-gray-200 p-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400 md:text-base">Days Sober</span>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-2xl border-2 border-gray-200 p-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400 md:text-base">Recovery XP</span>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-2xl border-2 border-gray-200 p-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400 md:text-base">Major Milestones</span>
          </div>
        </div>
      </div>
    </section>
