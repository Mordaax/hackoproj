...
const Donations: React.FC<DonationsProps> = ({
  ...
  const [confirmDonation, setConfirmDonation] = useState<{
    title: string;
    newPoints: number;
    key: keyof typeof xpData;
  } | null>(null);
  ...
  const donationOptions = [
    {
      ...
      description:
        "Help individuals quit smoking through support groups and counseling.",
    },
    {
      key: "xp2",
      title: "Gambling Recovery Program",
      description:
        "Support gambling addiction recovery programs and helplines.",
    },
    {
      key: "xp3",
      title: "Counseling Services",
      description:
        "Fund professional counseling for those in need of mental health support.",
    },
    {
      key: "xp4",
      title: "General Recovery Fund",
      description:
        "Contribute to a general fund supporting various recovery programs.",
    },
  ];
  ...
  const confirmDonationAction = async () => {
    ...
    await supabase
      .from("xpcount")
      .update({ [key]: xpData[key] + 100 })
      .eq("id", 1);

    // Close popup and redirect to transaction page
    setConfirmDonation(null);
    router.push(
      `/transaction?programTitle=${encodeURIComponent(confirmDonation.title)}`
    );
  };
  ...
  return (
    <div className="flex justify-center gap-3 pt-14 sm:p-6 sm:pt-10">
      <div className="px-4 pb-20">
        ...
        <p className="mb-4">
          Use your earned Recovery XP to make microdonations and support
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="mb-4 text-black">
                Points after donation: {confirmDonation.newPoints}
              </p>
...
const DonationOption = ({
  ...
  const buttonWidth =
    totalxp > 0 ? Math.max(10, (xpcount / totalxp) * 100) : 10;
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center gap-2 mt-2">
          <button
            ...
            style={{
              minWidth: "120px",
              width: `${Math.max(30, buttonWidth * 2)}%`,
            }}
